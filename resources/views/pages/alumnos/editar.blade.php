...
<div class="container">
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            @endif
            <form id="formAlumno" class="form-sample" method="POST" action="{{route('alumnos.update', $alumno->id)}}">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="">Rut</label>
                            <input id="rut" name="rut" type="text" class="form-control" value="{{$alumno->rut}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="salud" >
                                <option value="{{$alumno->salud}}" selected="selected">{{$alumno->salud}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="vive">
                                <option value="{{$alumno->vive}}">{{$alumno->vive}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="social">
                                <option value="{{$alumno->social}}">{{$alumno->social}}</option>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="apodrado1" name="apodrado1" type="text" class="form-control" value="{{$alumno->apodrado1}}">
                        </div>
                        <div class="form-group">
                            <label>Apodrado 2</label>
                            <input id="apodrado2" name="apodrado2" type="text" class="form-control" value="{{$alumno->apodrado2}}">
                        </div>
                        <div class="form-group">
                            <label>Fono/Contacto</label>
                            <input id="telefono" name="telefono" type="text" class="form-control" value="{{$alumno->telefono}}">
                        </div>
                        <div class="form-group">
                            <label for="">PIE</label>
                            <select class="form-control" name="pie">
                                <option value="{{$alumno->pie}}">{{$alumno->pie}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input id="diagnostico" name="diagnostico" type="text" class="form-control" value="{{$alumno->diagnostico}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="tipo">
                                <option value="{{$alumno->tipo}}">{{$alumno->tipo}}</option>
                        ...
                        <div class="form-group">
                            <label>Curso</label>
                            <input id="curso" name="curso" type="text" class="form-control" value="{{$alumno->curso}}">
                        </div>
                        <div class="form-group">
                            <label for="">Repitencia</label>
                            <select class="form-control" name="repitencia">
                                <option value="{{$alumno->repitencia}}">{{$alumno->repitencia}}</option>
                                <option value="Si">Si</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6">
                                <button id="send" class="btn btn-success btn-lg btn-block "
